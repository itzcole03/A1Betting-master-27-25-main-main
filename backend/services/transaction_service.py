...
from models.api_models import TransactionModel, ActiveBetModel
...
class TransactionService:
    ...
    async def get_user_active_bets(
        ...
        try:
            ...
            active_bets = [
                ActiveBetModel(**bet_data)
                for bet_data in paginated_bets
            ]
            
            self.logger.info(f"Retrieved {len(active_bets)} active bets for user {user_id}")
            return active_bets
