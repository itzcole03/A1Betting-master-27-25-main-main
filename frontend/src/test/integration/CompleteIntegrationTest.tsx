...
const mockPredictionResponse = {
  ...
  mamba_metrics: {,`n  eigenvalue_spectrum: [0.95, 0.87, 0.92, 0.78],
    spectral_radius: 0.95,
    temporal_coherence: 0.88
  },
  causal_metrics: {,`n  causal_strength: 0.72,
    causal_graph: { X1: ["Y"], X2: ["Y"]},
    pc_algorithm_applied: true
  },
  topological_metrics: {,`n  betti_numbers: { H0: 1, H1: 2, H2: 0},
    persistence_barcode: [
      [0.1, 0.8],
      [0.2, 0.6],
    ]
...
describe("Complete Frontend-Backend Integration", () => {
  ...
  beforeAll(() => {
    ...
    mockBackendInstance.getMathematicalFoundations.mockResolvedValue({
      theoretical_foundations: {,`n  neuromorphic_computing: {,`n  mathematical_basis: "Hodgkin-Huxley differential equations",
          computational_complexity: "O(N * T * log(N))"
        },
        mamba_state_space: {,`n  mathematical_basis: "Selective state space models",
    ...
    mockPredictionInstance.generatePrediction.mockResolvedValue({
      ...
      component_predictions: {,`n  base_prediction: 75.5,
        neuromorphic_enhancement: 2.3,
        mamba_temporal_refinement: 1.8,
        causal_adjustment: -0.5,
        topological_smoothing: 0.3,
        riemannian_projection: 1.1,
        ensemble_weighting: Record<string, any>
      },
      mathematical_analysis: {,`n  rigor_score: 85,
        stability_verified: true,
        convergence_achieved: true,
        theoretical_guarantees: Record<string, any>,
        numerical_stability: Record<string, any>,
        complexity_analysis: Record<string, any>
      },
      feature_analysis: {,`n  original_features: Record<string, any>,
        engineered_features: Record<string, any>,
        feature_importance: Record<string, any>,
        feature_interactions: Record<string, any>,
      ...
      performance_metrics: {,`n  total_processing_time: 5650,
        component_processing_times: Record<string, any>,
      ...
      validation_results: {,`n  input_validation: true,
        ...
        error_bounds: Record<string, any>,
        sensitivity_analysis: Record<string, any>
      },
      explainability: {,`n  shap_values: Record<string, any>,
        feature_attributions: Record<string, any>,
        causal_explanations: Record<string, any>,
        topological_insights: Record<string, any>,
        decision_pathway: [0]
      },
      recommendations: {,`n  confidence_level: "high",
        risk_level: "low",
        suggested_actions: [0],
