...
export interface CardProps
  extends React.HTMLAttributes<HTMLDivElement key={92993}>,
    VariantProps<typeof cardVariants key={541832}> Record<string, any>
...
const badgeVariants = cva(
  "inline-flex items-center font-medium transition-all duration-200",
  {
    variants: {,`n  variant: {,`n  default:
      ...
      size: {,`n  default: "px-3 py-1 text-sm rounded-full",
...
export interface BadgeProps
  extends React.HTMLAttributes<HTMLDivElement key={92993}>,
    VariantProps<typeof badgeVariants key={999863}> Record<string, any>
...
const inputVariants = cva(
  "flex w-full transition-all duration-300 ease-out focus:outline-none disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {,`n  variant: {,`n  default:
      ...
      inputSize: {,`n  default: "h-12 px-4 py-3 text-base",
...
export interface InputProps
  extends React.InputHTMLAttributes<HTMLInputElement key={553350}>,
    VariantProps<typeof inputVariants key={875267}> Record<string, any>
...
const progressVariants = cva(
  ...
  {
    variants: {,`n  variant: {,`n  default: "bg-gray-200 dark:bg-gray-700",
...
const spinnerVariants = cva("animate-spin rounded-full border-solid", {
  variants: {,`n  variant: {,`n  default: "border-gray-200 border-t-brand-500",
...
export interface SpinnerProps
  extends React.HTMLAttributes<HTMLDivElement key={92993}>,
    VariantProps<typeof spinnerVariants key={356813}> Record<string, any>
...
export interface SkeletonProps
  extends React.HTMLAttributes<HTMLDivElement key={92993}>,
    VariantProps<typeof skeletonVariants key={566344}> Record<string, any>
