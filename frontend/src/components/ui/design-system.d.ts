  ...
  props?:
    | ({
        variant?:
          ...
          | null
          | undefined;
        size?: 'default' | 'sm' | 'lg' | 'xl' | 'icon' | null | undefined;} & import('class-variance-authority/dist/types').ClassProp)
    | undefined
) => string;
...
declare const cardVariants: (
  props?:
    | ({
        ...
        rounded?: 'default' | 'lg' | 'xl' | 'full' | null | undefined;} & import('class-variance-authority/dist/types').ClassProp)
    | undefined
) => string;
export interface CardProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof cardVariants> Record<string, any>
  ...
  props?:
    | ({
        variant?:
          ...
          | null
          | undefined;
        size?: 'default' | 'sm' | 'lg' | null | undefined;} & import('class-variance-authority/dist/types').ClassProp)
    | undefined
) => string;
export interface BadgeProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof badgeVariants> Record<string, any>
...
declare const inputVariants: (
  props?:
    | ({
        ...
        rounded?: 'default' | 'none' | 'lg' | 'full' | null | undefined;} & import('class-variance-authority/dist/types').ClassProp)
    | undefined
) => string;
export interface InputProps
  extends React.InputHTMLAttributes<HTMLInputElement>,
    VariantProps<typeof inputVariants> Record<string, any>
...
declare const progressVariants: (
  props?:
    | ({
        ...
        rounded?: 'default' | 'none' | 'lg' | null | undefined;} & import('class-variance-authority/dist/types').ClassProp)
    | undefined
) => string;
declare const progressFillVariants: (
  props?:
    | ({
...
declare const spinnerVariants: (
  props?:
    | ({
        ...
        size?: 'default' | 'sm' | 'lg' | 'xl' | null | undefined;} & import('class-variance-authority/dist/types').ClassProp)
    | undefined
) => string;
...
declare const skeletonVariants: (
  props?:
    | ({
        variant?: 'button' | 'text' | 'default' | 'avatar' | 'card' | null | undefined} & import('class-variance-authority/dist/types').ClassProp)
    | undefined
) => string;
export interface SkeletonProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof skeletonVariants> Record<string, any>
