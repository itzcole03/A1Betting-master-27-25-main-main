...
export const MarketOpportunityCard: React.FC<MarketOpportunityCardProps> = ({ opportunity, onPlaceBet }) => {
    return (
        <GlassCard>
            <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-lg font-semibold">{formatPercentage(opportunity.probability)}</span>
                    </div>
                    <div className="flex flex-col">
                        <span className="text-sm text-gray-400">Expected Value</span>
                        <span className="text-lg font-semibold">{formatPercentage(opportunity.expected_value)}</span>
                    </div>
                    <div className="flex flex-col">
                        <span className="text-sm text-gray-400">Confidence</span>
                        <span className="text-lg font-semibold">{formatPercentage(opportunity.confidence)}</span>
                    </div>
                </div>
