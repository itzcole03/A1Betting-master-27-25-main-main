...
export const ArbitrageScanner: React.FC = () => {
  ...
  const generateOpportunities = () => {
    ...
    for (let i = 0; i < 5; i++) {
      ...
      mockOpportunities.push({
        ...
        timeRemaining: `${Math.floor(Math.random() * 59 + 1)}:${Math.floor(Math.random() * 59).toString().padStart(2, '0')}`,
        sport: sport,
  ...
  const generateOdds = () => {
    const american = Math.random() > 0.5 
        ...
        <Card className="p-12 bg-gradient-to-r from-yellow-900/20 to-orange-900/20 border-yellow-500/30">
          ...
          <div className="flex items-center justify-center gap-8">
            ...
            <div className="text-left">
              <div className="text-3xl font-bold text-yellow-400">{filteredOpportunities.length}</div>
            ...
            <Card className="p-6 border-yellow-500/30 hover:border-yellow-500/50 transition-all">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div className="space-y-1">
                      ...
                      <div className="text-lg font-mono font-bold text-green-400">{opportunity.book1Odds}</div>
                    </div>
                    <div className="space-y-1">
                      <div className="text-sm text-gray-400">Book 2: {opportunity.book2}</div>
                      <div className="text-lg font-mono font-bold text-red-400">{opportunity.book2Odds}</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 text-sm">
                    ...
                    <span className="text-gray-400">Confidence: {opportunity.confidence.toFixed(1)}%</span>
                    <span className="text-gray-400">•</span>
                ...
                <div className="text-center space-y-3">
                  <div>
                    <div className="text-3xl font-bold text-yellow-400">+{opportunity.roi.toFixed(2)}%</div>
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    ...
                    <div>
                      <div className="font-bold text-green-400">+${opportunity.profit.toFixed(2)}</div>
