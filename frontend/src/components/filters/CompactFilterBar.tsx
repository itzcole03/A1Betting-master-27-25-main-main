    ...
    <div className={`flex items-center space-x-4 ${className}`}>
      ...
      <div className='flex items-center space-x-2'>
          ...
          {filters.sports.slice(0, 4).map(sportId => {
            ...
            return sport ? (
              ...
              >
                ...
                <button onClick={() => clearSport(sportId)}
        ...
        <div className='relative'>
          <button onClick={() => setActiveDropdown(activeDropdown === 'sports' ? null : 'sports')}
                ...
                <div className='p-3'>
                  ...
                  <div className='grid grid-cols-2 gap-1'>
                    {QUICK_SPORTS.map(sport => (
                      <button key={sport.id}>`n                        onClick={() => toggleSport(sport.id)}
              ...
              >
                <div className='p-2'>
                  {QUICK_TIMEFRAMES.map(timeframe => (
                    <button key={timeframe.id}>`n                      onClick={() => selectTimeFrame(timeframe.id)}
      ...
      {onOpenFullFilters && (
        <button onClick={onOpenFullFilters}
