...
import { AlertTriangle, BarChart3, CheckCircle, Clock, Pause, Play, Settings, Shield, Zap } from 'lucide-react';
...
export const AutoPilot: React.FC = () => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'placed': return 'text-green-400 border-green-400';
          ...
          <div className="flex items-center justify-center gap-8">
            ...
            {stats && (
              <div className="grid grid-cols-4 gap-8 text-center">
                <div>
                  <div className={`text-3xl font-bold ${isGlobalActive ? 'text-green-400' : 'text-gray-400'}`}>
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        <Badge variant="outline" className={rule.isActive ? 'text-green-400 border-green-400' : 'text-red-400 border-red-400'}>
                      ...
                      <div className="text-sm space-y-1">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="text-white">
                            {rule.action.stakeType === 'percentage' ? `${rule.action.amount}%` : 
                             rule.action.stakeType === 'kelly' ? `${rule.action.amount}% Kelly` :
                             `$${rule.action.amount}`}
                          </span>
                        </div>
                        <div className="flex justify-between">
                    ...
                    <div>
                      ...
                      <div className="text-sm space-y-1">
                        <div className="flex justify-between">
                          ...
                          <span className="text-white">{rule.filters.minOdds} to {rule.filters.maxOdds}</span>
                        </div>
                        <div className="flex justify-between">
                    ...
                    <div>
                      ...
                      <div className="text-sm space-y-1">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="text-white">{rule.safetyLimits.maxConsecutiveLosses}</span>
                        </div>
                        <div className="flex justify-between">
              ...
              {executions.slice(0, 8).map((execution, index) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between text-xs">
                    <span className="text-gray-400">Confidence: {execution.confidence.toFixed(0)}%</span>
