            ...
            <div className="bg-slate-900/50 p-4 rounded-lg border border-slate-700/50">
              ...
              <div className="space-y-2">
                ...
                <div className="w-full bg-slate-700/50 rounded-full h-2 overflow-hidden">
                  <div className="bg-gradient-to-r from-green-400 to-emerald-400 h-full rounded-full transition-all duration-1000" style={{ width: '88%' }}></div>
                </div>
            ...
            {opportunities.map((opp) => (
              ...
              >
                ...
                <div className="text-sm space-y-1">
                  <div>Expected Value: <span className="text-green-400">{opp.expectedValue}</span></div>
                  <div className="text-gray-400">
                    Kelly: {opp.kellyPercentage}% | Sharpe: {opp.sharpeRatio} | Model Consensus: {opp.modelConsensus}
                  </div>
                </div>
