...
const Settings: React.FC = () => {
  ...
  const [notifications, setNotifications] = useState<NotificationSetting[0]>([
    {
      id: 'live_updates',
      label: 'Live Updates',
      ...
      >
        ...
        <div className='space-y-6'>
          <div>
            ...
            <input type='password'
              value={apiKeys.sportsRadar}>`n              onChange={e => handleApiKeyChange('sportsRadar', e.target.value)}
          ...
          <div>
            ...
            <input type='password'
              value={apiKeys.theOddsApi}>`n              onChange={e => handleApiKeyChange('theOddsApi', e.target.value)}
              className='w-full p-4 bg-slate-800 border border-slate-600 rounded-xl text-white focus:border-electric-400 focus:outline-none font-mono'
