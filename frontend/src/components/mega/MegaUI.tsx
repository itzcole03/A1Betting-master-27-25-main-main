...
export const MegaButton: React.FC<{,`n  children: ReactNode;
  ...
  const getVariantStyle = () => {
    const variants = {
      ...
      secondary: {,`n  background: "rgba(255, 255, 255, 0.04)",
      ...
      ghost: {,`n  background: "rgba(6, 255, 165, 0.08)",
        ...
        if (!disabled && !loading) {
          ...
          if (variant === "primary") {
            e.currentTarget.style.boxShadow =
              "0 12px 48px rgba(6, 255, 165, 0.4), 0 4px 16px rgba(0, 0, 0, 0.2)";} else if (variant === "secondary") {
            e.currentTarget.style.boxShadow = "0 8px 32px rgba(0, 0, 0, 0.2)";
            e.currentTarget.style.background = "rgba(255, 255, 255, 0.08)";} else if (variant === "ghost") {
...
//   onClick
  ...
  const getVariantStyle = () => {
    const variants = {
      default: {,`n  backgroundColor: "rgba(255, 255, 255, 0.03)",
      ...
      glowing: {,`n  backgroundColor: "rgba(255, 255, 255, 0.04)",
        border: `1px solid rgba(6, 255, 165, 0.3)`,
        boxShadow: `0 0 32px rgba(6, 255, 165, 0.2), 0 8px 32px rgba(0, 0, 0, 0.2)`,
        backdropFilter: "blur(40px) saturate(200%)"
      },
      bordered: {,`n  backgroundColor: "rgba(255, 255, 255, 0.02)",
...
export const MegaAlert: React.FC<{,`n  type: "info" | "success" | "warning" | "error";
  ...
  const getAlertStyle = () => {
    const styles = {
      info: {,`n  backgroundColor: `${CYBER_COLORS.accent}10`,
        border: `1px solid ${CYBER_COLORS.accent}30`,
        color: CYBER_COLORS.accent
      },
      success: {,`n  backgroundColor: `${CYBER_COLORS.primary}10`,
        border: `1px solid ${CYBER_COLORS.primary}30`,
        color: CYBER_COLORS.primary
      },
      warning: {,`n  backgroundColor: "rgba(255, 193, 7, 0.1)",
        border: "1px solid rgba(255, 193, 7, 0.3)",
        color: "#ffc107"
      },
      error: {,`n  backgroundColor: "rgba(255, 71, 87, 0.1)",
...
export const MegaSkeleton: React.FC<{
  ...
  const animationStyle = {
    pulse: {,`n  animation: "pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite"
    },
    wave: {,`n  background:
