...
const BankrollPage: React.FC = () => {
  ...
  const generateTransactions = (): Transaction[] => {
    ...
    for (let i = 0; i < 10; i++) {
      ...
      const types: Transaction['type'][] = ['win', 'loss', 'deposit', 'withdrawal'];
  ...
  return (
    <main className="section space-y-6 lg:space-y-8 animate-fade-in">
      <div className="modern-card p-6 lg:p-8">
        ...
        {/* Loading/Error State */}
        {loading ? (
          <div className="text-center text-gray-500 dark:text-gray-400">Loading bankroll data...</div>
        ) : error ? (
            ...
            <div className="modern-card p-6 mb-8">
              ...
              <div className="h-64 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-400">Real-time balance tracking: ${currentBalance.toLocaleString()}</p>
                  <p className="text-green-500 text-sm mt-2">Consistent growth with {roi.toFixed(1)}% ROI</p>
                </div>
              </div>
            </div>
