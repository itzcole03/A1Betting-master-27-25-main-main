...
export const PrizePicksProUnified: React.FC<PrizePicksProUnifiedProps> = ({
  ...
  const generateComprehensiveMockProjections = (): PrizePicksProjection[] => {
    ...
    const comprehensiveStatTypes = {
      ...
      WNBA: ['Points', 'Assists', 'Rebounds', '3-Pointers', 'Steals', 'Blocks', 'Minutes'],
      NFL: [
        'Passing Yards',
        'Rushing Yards',
        'Receiving Yards',
      ...
      NHL: ['Goals', 'Assists', 'Points', 'Shots', 'Saves', 'Save Percentage', 'Time on Ice'],
      MLS: ['Goals', 'Assists', 'Shots', 'Shots on Target', 'Passes', 'Tackles', 'Yellow Cards'],
      NCAAF: [
        'Passing Yards',
        'Rushing Yards',
        'Receiving Yards',
      ...
      NCAAB: ['Points', 'Assists', 'Rebounds', '3-Pointers', 'Steals', 'Blocks', 'Minutes'],
      NCAAM: ['Points', 'Assists', 'Rebounds', '3-Pointers', 'Steals', 'Blocks', 'Minutes'],
      NCAAW: ['Points', 'Assists', 'Rebounds', '3-Pointers', 'Steals', 'Blocks', 'Minutes'],
      EPL: ['Goals', 'Assists', 'Shots', 'Shots on Target', 'Passes', 'Tackles', 'Yellow Cards'],
      UEFA_CHAMPIONS_LEAGUE: ['Goals', 'Assists', 'Shots', 'Shots on Target', 'Passes', 'Tackles'],
      UEFA_EUROPA_LEAGUE: ['Goals', 'Assists', 'Shots', 'Shots on Target', 'Passes', 'Tackles'],
      LA_LIGA: [
        'Goals',
        'Assists',
        'Shots',
      ...
      PREMIER_LEAGUE: ['Goals', 'Assists', 'Shots', 'Shots on Target', 'Passes', 'Tackles'],
      CHAMPIONSHIP: ['Goals', 'Assists', 'Shots', 'Shots on Target', 'Passes', 'Tackles'],
      LIGA_MX: ['Goals', 'Assists', 'Shots', 'Shots on Target', 'Passes', 'Tackles'],
      PGA: [
        'Strokes',
        'Birdies',
        'Eagles',
      ...
      NASCAR: ['Finishing Position', 'Laps Led', 'Top 5 Finish', 'Top 10 Finish', 'Fastest Lap'],
      F1: ['Finishing Position', 'Points', 'Fastest Lap', 'Pole Position', 'Podium Finish'],
      UFC: ['Significant Strikes', 'Takedowns', 'Submission Attempts', 'Fight Time', 'Knockdowns'],
      BOXING: ['Punches Landed', 'Jabs Landed', 'Power Punches', 'Round Wins', 'Knockdowns'],
      TENNIS: [
        'Aces',
        'Double Faults',
        'First Serve %',
      ...
      GOLF_MAJOR: ['Strokes', 'Birdies', 'Eagles', 'Pars', 'Bogeys', 'Fairways Hit'],
      LOL: ['Kills', 'Deaths', 'Assists', 'CS', 'Gold', 'Damage'],
      CSGO: ['Kills', 'Deaths', 'Assists', 'ADR', 'KAST', 'Rating'],
      VALORANT: ['Kills', 'Deaths', 'Assists', 'ADR', 'KAST', 'ACS'],
      DOTA2: ['Kills', 'Deaths', 'Assists', 'GPM', 'XPM', 'Last Hits'],
      CRICKET: ['Runs', 'Wickets', 'Boundaries', 'Strike Rate', 'Economy Rate', 'Catches'],
      RUGBY: ['Tries', 'Conversions', 'Penalties', 'Tackles', 'Meters', 'Line Breaks'],
      AUSSIE_RULES: ['Goals', 'Behinds', 'Disposals', 'Marks', 'Tackles', 'Kicks'],
      CFL: ['Passing Yards', 'Rushing Yards', 'Receiving Yards', 'Touchdowns', 'Receptions'],
      EUROLEAGUE: ['Points', 'Assists', 'Rebounds', '3-Pointers', 'Steals', 'Blocks'],
      NBL: ['Points', 'Assists', 'Rebounds', '3-Pointers', 'Steals', 'Blocks'],
      FIBA: ['Points', 'Assists', 'Rebounds', '3-Pointers', 'Steals', 'Blocks'],
      G_LEAGUE: ['Points', 'Assists', 'Rebounds', '3-Pointers', 'Steals', 'Blocks'],
      AHL: ['Goals', 'Assists', 'Points', 'Shots', 'Saves', 'Plus/Minus'],
