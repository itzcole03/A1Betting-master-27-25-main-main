  ...
  return (
    <main className='section space-y-6 lg:space-y-8 animate-fade-in' key={94246}>
      <section className='glass-card rounded-2xl shadow-xl p-6 mb-8 animate-fade-in animate-scale-in'
        key={289937}>`n      >
        <h2 className='text-2xl font-bold text-blue-100 mb-4' key={235933}>
          Advanced Analytics
        </h2>
        <AdvancedAnalytics key={998698} />
      </section>
      <div className='modern-card p-6 lg:p-8' key={672448}>
        <h1 className='text-2xl lg:text-3xl font-bold mb-6' key={865743}>
          📊 Analytics
        </h1>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6' key={881323}>
          ...
          <div className='modern-card p-6' key={889527}>
            <h3 className='text-lg font-bold mb-4' key={826233}>
              Performance Overview
            </h3>
          ...
          <div className='modern-card p-6' key={889527}>
            ...
            <div className='space-y-4' key={160407}>
              ...
              <div className='flex justify-between' key={588832}>
                ...
                <span className='font-bold text-red-600' key={501718}>
                  -2.4%
                </span>
              </div>
            </div>
...
//                     NBA
                  ...
                  <td className='px-6 py-4 whitespace-nowrap text-green-600' key={651292}>
                    68.2%
                  </td>
                  <td className='px-6 py-4 whitespace-nowrap text-green-600' key={651292}>
                    +25.4%
...
//                     MLB
                  ...
                  <td className='px-6 py-4 whitespace-nowrap text-red-600' key={613365}>
                    48.3%
                  </td>
                  <td className='px-6 py-4 whitespace-nowrap text-red-600' key={613365}>
                    -5.2%
