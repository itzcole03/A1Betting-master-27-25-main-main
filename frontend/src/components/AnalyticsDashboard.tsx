            ...
            <div className="grid grid-cols-4 gap-8 text-center">
              <div>
                <div className="text-3xl font-bold text-indigo-400">
                  {timeSeriesData.length > 0 ? timeSeriesData[timeSeriesData.length - 1].profit.toFixed(0) : 0}
                </div>
            ...
            {sportAnalytics.map((sport, index) => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <Badge variant="outline" className={sport.profit > 0 ? 'text-green-400 border-green-400' : 'text-red-400 border-red-400'}>
                ...
                <div className="grid grid-cols-3 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <div className={`font-bold ${sport.roi > 0 ? 'text-green-400' : 'text-red-400'}`}>
                      {sport.roi.toFixed(1)}%
                    </div>
                  </div>
                  <div>
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div>
                    ...
                    <p className="text-gray-400 text-xs">{model.predictions.toLocaleString()} predictions</p>
                  </div>
                  
                  <Badge variant="outline" className={model.profit > 0 ? 'text-green-400 border-green-400' : 'text-red-400 border-red-400'}>
                ...
                <div>
                  <div className="flex justify-between text-xs mb-1">
                    ...
                    <span className="text-white">{((model.accuracy + model.confidence) / 2).toFixed(1)}%</span>
                  </div>
                  <div className="w-full bg-gray-700 rounded-full h-2">
                    <motion.div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-6">
          <div className="text-center">
            <div className="text-2xl font-bold text-green-400">
              {timeSeriesData.length > 0 ? `+${(timeSeriesData[timeSeriesData.length - 1].profit - timeSeriesData[0].profit).toFixed(0)}` : 0}
            </div>
          ...
          <div className="text-center">
            <div className="text-2xl font-bold text-yellow-400">
              {timeSeriesData.length > 0 ? (timeSeriesData.reduce((sum, d) => sum + d.winRate, 0) / timeSeriesData.length).toFixed(1) : 0}%
            </div>
