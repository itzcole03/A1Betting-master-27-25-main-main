          ...
          <div style={{
            ...
            <div style={{ maxWidth: '400px', margin: '0 auto' }}>
              ...
              <p style={{
                ...
                Waiting for live PrizePicks projections to analyze using our advanced prediction models.
              </p>
              <div style={{
                ...
                <div style={{
                  ...
                  <motion.button
                    ...
                    style={{
                      ...
                      fontWeight: 'bold',
                      border: '2px solid',
                      background: isOverSelected ? 'rgba(34, 197, 94, 0.3)' : 'rgba(30, 41, 59, 0.5)',
                  ...
                  <motion.button
                    ...
                    style={{
                      ...
                      fontWeight: 'bold',
                      border: '2px solid',
                      background: isUnderSelected ? 'rgba(239, 68, 68, 0.3)' : 'rgba(30, 41, 59, 0.5)',
                  ...
                  {prop.expected_value && (
                    <div style={{
                      ...
                      <p style={{
                        ...
                        Recommendation: {prop.recommendation} • Expected Value: {(prop.expected_value * 100).toFixed(1)}%
        ...
        >
          ...
          <div style={{
            ...
            <div style={{
              ...
              {selectedProps.size >= 2 ? `${selectedProps.size} picks selected` : `Select ${2 - selectedProps.size} more`}
            </div>
          </div>
