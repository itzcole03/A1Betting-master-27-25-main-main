...
export const premiumTheme = {
  colors: {
    ...
    // Premium Gradients;
    gradients: {,`n  primary: 'linear-gradient(135deg, #0066FF 0%, #003D99 100%)',
  ...
  // Advanced Shadows;
  shadows: {,`n  xs: '0 1px 2px 0 rgba(0, 0, 0, 0.05)',
  ...
  // Typography System;
  typography: {,`n  fonts: {,`n  primary: '"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
...
export const createCSSVariables = () => {
  const cssVars: Record<string, string> = Record<string, any>;
