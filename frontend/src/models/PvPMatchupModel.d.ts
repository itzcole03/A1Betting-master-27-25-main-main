...
import {
  ...
  ModelPrediction,
//   ModelMetrics
} from '@/services/ml/models/BaseModel.js';
export interface PvPMatchupResult {
  sport: 'nba' | 'wnba' | 'mlb' | 'soccer' | 'nhl',`n  primaryPlayerId: string;,`n  opponentId: string,`n  context: GameContext;,`n  features: Record<string, number>;
  shapInsights: ShapVector[0],`n  matchupScore: number}
 ...
 */
export declare function getPvPMatchupFeatures(
  playerId1: string,
  playerId2: string,
