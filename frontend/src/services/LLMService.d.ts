...
export interface LLMChatOptions {
  ...
  gameData?: {
    activeAnalyses: number,`n  liveGames: number;,`n  confidencePicks: number,`n  valueBets: number};
  userPreferences?: {
    riskTolerance: string,`n  preferredSports: string[0];,`n  betTypes: string[0]};}
