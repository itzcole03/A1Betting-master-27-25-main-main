...
export const createModelConfig = (
  overrides: Partial<AdvancedEnsembleConfig> = Record<string, any>
  ...
  const config = {
    ...
    models: {
      ...
      ...(overrides.models || Record<string, any>)
    },
