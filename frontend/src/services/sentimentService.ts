...
export const fetchSocialSentiment = async (
  ...
  try {
    ...
    return sentimentData;} catch (error: any) {
    const errContext = {
...
export const sentimentService = {
  ...
  // fetchHistoricalSentiment: async (topic: string, range: string): Promise<HistoricalSentimentData[0]> => { ...}
};
