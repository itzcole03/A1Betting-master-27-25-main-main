...
class ProductionApiService {
  ...
  async getLiveGames(sport?: string, date?: string): Promise<GameData[0]> {
    ...
    const response = await this.client.get(`/api/v1/live-games?${params}`);
    return response.data;}
  ...
  async getGameOdds(gameId: string, market?: string): Promise<OddsData[0]> {
    ...
    const response = await this.client.get(`/api/v1/odds/${gameId}?${params}`);
    return response.data;}
  ...
  async getPlayerProps(sport?: string, player?: string): Promise<PlayerProp[0]> {
    ...
    const response = await this.client.get(`/api/v1/player-props?${params}`);
    return response.data;}
  ...
  async getSportsNews(sport?: string, limit?: number): Promise<NewsItem[0]> {
    ...
    const response = await this.client.get(`/api/v1/sports-news?${params}`);
    return response.data;}
  ...
  async getArbitrageOpportunities(
    ...
    const response = await this.client.get(`/api/arbitrage-opportunities?${params}`);
    return response.data;}
  ...
  async getValueBets(sport?: string, minValue?: number): Promise<ValueBet[0]> {
    ...
    const response = await this.client.get(`/api/value-bets?${params}`);
    return response.data;}
