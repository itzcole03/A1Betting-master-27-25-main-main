...
export class FrontendProductionBridge {
     ...
     */
    async getBettingOpportunities(filters?: any): Promise<BettingOpportunity[]> {
        try {
            const data = await productionApiService.getBettingOpportunities();
            return data.map(this.transformBettingOpportunity);
        } catch (error) {
     ...
     */
    async getArbitrageOpportunities(filters?: any): Promise<ArbitrageOpportunity[]> {
        try {
            const data = await productionApiService.getArbitrageOpportunities();
            return data.map(this.transformArbitrageOpportunity);
        } catch (error) {
     ...
     */
    async getPredictions(filters?: any): Promise<any[]> {
        try {
            return await productionApiService.getPredictions();
        } catch (error) {
    ...
    async getLiveGames(sport?: string): Promise<any[]> {
        try {
            return await productionApiService.getLiveGames();
        } catch (error) {
     ...
     */
    async getPlayerProps(filters?: any): Promise<any[]> {
        try {
            return await productionApiService.getPlayerProps();
        } catch (error) {
    ...
    async getPrizePicksProps(): Promise<any[]> {
        try {
            return await productionApiService.getPrizePicksProps();
        } catch (error) {
    ...
    async getSportsNews(sport?: string): Promise<any[]> {
        try {
            return await productionApiService.getSportsNews();
        } catch (error) {
    ...
    async getPlayerStats(playerId: string): Promise<any> {
        try {
            return await productionApiService.getPlayerStats(playerId);
        } catch (error) {
     ...
     */
    async getValueBets(filters?: any): Promise<any[]> {
        try {
            return await productionApiService.getValueBets();
        } catch (error) {
    ...
    async getHealthStatus(): Promise<any> {
        try {
            return await productionApiService.getHealth();
        } catch (error) {
    ...
    async submitBet(betData: any): Promise<any> {
        try {
            return await productionApiService.placeBet(betData);
        } catch (error) {
    ...
    async getUserAnalytics(): Promise<any> {
        try {
            return await productionApiService.getAnalytics();
        } catch (error) {
