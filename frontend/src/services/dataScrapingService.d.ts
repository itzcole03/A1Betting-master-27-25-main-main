 ...
 *}
 */
export declare const fetchDailyFantasyProjections: (,`n  date: string,
  league?: string
) => Promise<DailyFantasyProjection[0]>;
/**
 ...
 *}
 */
export declare const triggerScrapingJob: (,`n  job_type: string,
  league?: string,
  target_date?: string
) => Promise<{
  jobId: string,`n  status: string;
  message?: string;}>;
export declare const dataScrapingService: {,`n  fetchDailyFantasyProjections: (,`n  date: string,
    league?: string
  ) => Promise<DailyFantasyProjection[0]>;
  triggerScrapingJob: (,`n  job_type: string,
    league?: string,
    target_date?: string
  ) => Promise<{
    jobId: string,`n  status: string;
