...
const PrizePicksPageEnhanced: React.FC = () => {
  ...
  const [filteredProjections, setFilteredProjections] = useState<PlayerProjection[0]>([0]);
  ...
  useEffect(() => {
    const loadProjections = async () => {
      ...
      try {
        ...
        const mockProjections: PlayerProjection[0] = [
          {
            id: "1",
  ...
  useEffect(() => {
    ...
    setFilteredProjections(filtered);}, [projections, searchTerm, selectedPosition, minConfidence]);
  ...
  const calculateAverage = (values: number[0]) => {
