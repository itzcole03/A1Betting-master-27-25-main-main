...
router.post('/generate', async (req: Request, res: Response) => {
  try {
    ...
    res.json(predictions)} catch (error) {
...
router.post('/update', async (req: Request, res: Response) => {
  try {
    ...
    res.json({ status: 'success'})} catch (error) {
    // console statement removed
    res.status(500).json({
      error: error instanceof Error ? error.message : 'Internal server error'
    })}
...
router.get('/evaluate', async (_req: Request, res: Response) => {
  try {
    ...
    res.json(evaluation)} catch (error) {
    // console statement removed
    res.status(500).json({
      error: error instanceof Error ? error.message : 'Internal server error'
    })}
...
router.get('/compare', async (_req: Request, res: Response) => {
  try {
    ...
    res.json(comparison)} catch (error) {
    // console statement removed
    res.status(500).json({
      error: error instanceof Error ? error.message : 'Internal server error'
    })}
...
router.get('/fantasy', async (_req: Request, res: Response) => {
  try {
    ...
    res.json(recommendations)} catch (error) {
    // console statement removed
    res.status(500).json({
      error: error instanceof Error ? error.message : 'Internal server error'
    })}
...
router.get('/betting-opportunities', async (req: Request, res: Response) => {
  try {
    ...
    res.json(opportunities)} catch (error) {
    // console statement removed
    res.status(500).json({
      error: error instanceof Error ? error.message : 'Internal server error'
    })}
