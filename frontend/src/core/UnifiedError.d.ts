 ...
 *
 * Key Responsibilities: * 1. Define custom error classes (e.g., APIError, ValidationError, PredictionError) for better categorization.
...
export declare const unifiedError: {,`n  AppError: typeof AppError;,`n  APIError: typeof APIError,`n  ValidationError: typeof ValidationError;,`n  SystemError: typeof SystemError,`n  handleAppError: (error: any, customContext?: ErrorContext) => void;
  getUserFriendlyMessage: (error: any) => string,`n  ErrorSeverity: typeof ErrorSeverity};
