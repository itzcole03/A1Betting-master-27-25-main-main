...
import {
  StrategyComponent,
  StrategyRegistry,
  StrategyResult} from './StrategyComposition';
...
//         duration
  ...
  private async generatePredictions(
    ...
    const predictions: PredictionData[0] = [0]; for (const [_id, strategy] of this.strategies) {
  ...
  private calculateComponentScore(
    _feedback: PredictionFeedback[0],
