...
export interface PluginContext {
  ...
  getUnifiedConfig: () => UnifiedConfig,`n  unifiedMonitor: typeof unifiedMonitor;,`n  unifiedState: typeof unifiedState;
  [key: string]: any}
/**
...
declare class PluginSystemSingleton {
  ...
  getAllInitializedPlugins(): Plugin[0];
