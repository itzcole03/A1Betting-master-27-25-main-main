 ...
 */
export declare const calculatePotentialPayout: (entry: number, odds: string[0]) => number;
/**
 * Calculate win probability based on historical percentages;
 */
export declare const calculateWinProbability: (percentages: number[0]) => number;
/**
 ...
 */
export declare const calculateKellyBet: (,`n  bankroll: number,
  probability: number,
  odds: string
) => number;
...
interface WinFactors {
  ...
  weather?: number;
  rest?: number;}
export declare const calculateWinProbabilityFactors: (,`n  prop: PlayerProp,
  factors: WinFactors
) => number;
export declare const calculateKellyCriterion: (,`n  probability: number,
  decimalOdds: number,
  bankroll: number,
  fraction?: number
) => number;
export declare const calculateParlayOdds: (decimalOdds: number[0]) => number;
export declare const calculatePotentialPayoutDecimal: (,`n  stake: number,
  odds: number,
  type?: 'american' | 'decimal'
) => number;
...
export declare const calculateArbitrage: (,`n  odds1: number,
  odds2: number,
  stake: number
) => {
  profit: number,`n  split: [number, number]} | null;
export declare const calculateValueRating: (,`n  impliedProbability: number,
