  ...
  > & {
    persist: {,`n  setOptions: (,`n  options: Partial<
          import('zustand/middleware').PersistOptions<
            AppState,
            {
              user: User | null,`n  props: ProcessedPrizePicksProp[0];,`n  selectedProps: string[0],`n  entries: Entry[0];,`n  metrics: PerformanceMetrics | null,`n  opportunities: BettingOpportunity[0];,`n  alerts: Alert[0],`n  darkMode: boolean;,`n  sidebarOpen: boolean,`n  activeModal: string | null;,`n  bets: BetRecord[0],`n  toasts: any[0];,`n  isLoading: boolean,`n  error: Error | null}
          >
        >
      ) => void;
